...
class StandingOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('presentation::client.standing_orders.index', compact('orders'));
    }
    ...
    public function create()
    {
        ...
        return view('presentation::client.standing_orders.create', compact('accounts'));
    }
    ...
    {
        return view('presentation::client.standing_orders.show', compact('standingOrder'));
    }
